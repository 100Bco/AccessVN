...
const translations = {
  ...
  // Hero
  hero_date: {
    en: "May 30 – June 19, 2026",
    vi: "30 tháng 5 – 19 tháng 6, 2026",
  },
  hero_desc: {
  ...
  intro_desc: {
    ...
    vi: "Greater Austin Asian Chamber of Commerce <strong>(GAACC)</strong> là tổ chức đối tác hàng đầu trong việc thúc đẩy tăng trưởng kinh tế địa phương và mở ra cơ hội cho các doanh nghiệp có kết nối với châu Á cũng như cộng đồng người Mỹ gốc Á tại vùng trung tâm Texas. Phối hợp cùng City of Austin, GAACC đã khởi xướng chương trình Access Asia — sáng kiến thu hút đầu tư vào khu vực Greater Austin, đồng thời xây dựng các hợp tác đôi bên cùng có lợi trong lĩnh vực đầu tư quốc tế, thương mại, công nghệ, đổi mới sáng tạo, khởi nghiệp, sản xuất và hơn thế nữa.",
  },
